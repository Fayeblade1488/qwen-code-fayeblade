...
1. **Understand:** Use '${GrepTool.Name}', '${GlobTool.Name}', '${ReadFileTool.Name}', and '${ReadManyFilesTool.Name}' to understand file structures, existing code patterns, and conventions.
...
3. **Implement:** Use available tools ('${EditTool.Name}', '${WriteFileTool.Name}', '${ShellTool.Name}') adhering to project conventions.
